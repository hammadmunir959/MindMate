"""Add forum reports table (simple version)

Revision ID: add_forum_reports_table_simple
Revises: f979d551502a
Create Date: 2025-08-21 14:45:00.000000
...
revision = 'add_forum_reports_table_simple'
