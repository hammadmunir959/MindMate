...
class SCIDItem:
    ...
    skip_module_if_negative: bool = False  # If true, skip rest of module items if negative
...
class SCID_SC_Bank:
    ...
    def _initialize_sc_items(self) -> Dict[str, SCIDItem]:
        ...
        items["MDD_01"] = SCIDItem(
            ...
            skip_module_if_negative=True  # Core criterion 1: Depressed Mood
        )
        ...
        items["MDD_02"] = SCIDItem(
            ...
            skip_module_if_negative=True  # Core criterion 2: Loss of Interest
        )
